  ...
  <div>
    ...
    <transition name="fade">
      <button
        v-show="true"
        @click="toggleChat"
        class="cursor-pointer fixed bottom-6 p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-all duration-300 z-40 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
